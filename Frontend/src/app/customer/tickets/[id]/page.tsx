                  ...
                  <div className="flex flex-wrap gap-3">
                    {ticket.seats.map((seat, idx) => (
                      ...
                      >
                        ...
                        {seat.seat_ticket_number && (
                          <span className="text-xs font-medium text-slate-500 uppercase tracking-wider border-l border-slate-200 pl-2">
                             TKT: {seat.seat_ticket_number}
                          </span>
                        )}
                      </span>
                    ))}
